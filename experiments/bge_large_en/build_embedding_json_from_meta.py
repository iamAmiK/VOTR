...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Create MCP-Zero style embedding JSON from index meta.json using BGE."
    )
    ...
    ap.add_argument(
        "--out",
        type=Path,
        default=Path("data/bge_large_en/mcp_tools_with_embedding.bge-large-en-v1.5.json"),
    )
